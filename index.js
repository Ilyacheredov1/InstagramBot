...
(async () => {
    ...
    await ig.login('Password', 'Login'); // Ваш логин и пароль для инициализации

    //await ig.unsubscribe(); // отписывается от всех людей, которые не подписаны на вас, раскоментировать чтобы запустить 

    await ig.collection('https://www.instagram.com/p/Bym0Xvfownj/', 2500); // Вам нужно указать ссылку поста и бот соберет массив людей лайкнувших его, второй аргумент - длина массива, больше 2500 вам не нужно 
